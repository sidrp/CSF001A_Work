...
public class HallwaysWhile extends Object
{
   ...
   { 
      ...
      if (Jo.getDirection() == becker.robots.Direction.EAST)
      {
         Jo.move();
         Jo.pickThing();
         Jo.turnLeft();
      ...
      if (Jo.getDirection() == becker.robots.Direction.SOUTH)
      {
         Jo.move();
         Jo.turnLeft();
         Jo.turnLeft();
      ...
      if (Jo.getDirection() == becker.robots.Direction.WEST)
      {
         Jo.move();
         Jo.turnLeft();
         Jo.turnLeft();
      ...
      if (Jo.getDirection() == becker.robots.Direction.NORTH)
      {
         int i = 0;
         while (i < 5)
         {
